class intromaze extends Phaser.Scene {
  constructor() {
    super({
      key: "intromaze",
    });
  ...
  preload() {
    ...
    this.load.image("intromaze", "assets/intromaze.jpg");
  ...
  create() {
    ...
    // bg image
    this.add.sprite(550,310,"intromaze").setScale(0.25);
    ...
    //  this.add.text(200,600, 'press space to level 1!' , { font: '20px Fipps', fill: '#96450f'});
        ...
        spaceDown.on('down', function () {
            console.log('Jump to level2 scene');

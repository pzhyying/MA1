...
class world3 extends Phaser.Scene {
  ...
  this.player = this.physics.add.sprite(459, 865, 'girl').setScale(0.9)
  ...
  intromaze(player,title){
    console.log("intromaze function");
    this.scene.start("intromaze");
  }
